...
Example lab manual template. 

This is an "experimental" lab manual for the resonance tube. [Here](https://physics.nyu.edu/~physlab/GenPhysII_PhysIII/genphys2.html) is the original.  
